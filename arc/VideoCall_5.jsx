    ...
    <div className="fixed inset-0 z-9999 flex items-center justify-center bg-black/70 backdrop-blur-lg">
      <div className="relative flex h-[92vh] w-[92vw] max-w-7xl flex-col overflow-hidden rounded-3xl bg-neutral-900 shadow-2xl">
        ...
        <div className="relative flex flex-1 items-center justify-center p-6">
          {/* REMOTE VIDEO */}
          {console.log('this is remoteVideoRef', remoteVideoRef)}
          {remoteStream && (
            <div className="relative h-60 w-60 overflow-hidden rounded-3xl bg-black">
          ...
          {/* {console.log('this is localVideoRef', localVideoRef)} */}
          {/* LOCAL VIDEO */}
          {localStream && (
